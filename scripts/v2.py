...
csv_path = (
    "/zfsauton2/home/rmalcewi/summer2025/cifar10-gradient-inversion/saved_experiments/clip_experiment_summary.csv"
)
...
individual_classes = df.melt(
    id_vars=["batch_size", "batch_idx", "repetition", "recon_successes", "ori_successes"],
    value_vars=["class_a", "class_b"],
    var_name="class_type",
    value_name="individual_class",
)
plot_success_counts_with_baseline(
    individual_classes, "individual_class", "Successes per Individual Class", random_baseline
)
